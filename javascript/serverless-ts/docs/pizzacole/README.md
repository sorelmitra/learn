...
This variant became deprecated as soon as I've created it.

See warning below

# A Word of Warning!

The Serverless framework is nice but you DO PAY for some of the AWS resources it wants to create, e.g. CloudFormation Stacks.
