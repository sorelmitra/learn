 ...
 */
@Entity
public class NomadSession implements Serializable {
	...
	private static final long DEFAULT_GLOBAL_SESSION_TIMEOUT = 6000;
	...
	public void validate() throws StoppedSessionException, ExpiredSessionException {
		// check for stopped:
		if (isStopped()) {
