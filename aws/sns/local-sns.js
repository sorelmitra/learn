...
AWS_PROFILE=test-profile REGION=us-west-2 QUEUE_URLS=http://localhost:9334/queue/queue-local.fifo,http://localhost:9344/queue/queue-local.fifo node ~/1data/s/sorelmitra/learn/aws/sns/local-sns.js
